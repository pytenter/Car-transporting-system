...
class VehicleMission:
    ...
    # Collaborative task modeling: how much of the task load this vehicle carries.
    # For single-vehicle tasks, this equals the task weight.
...
class DispatchEvent:
    ...
    carried_weight_by_vehicle: Dict[int, float]
